    ...
    <main className={`h-screen w-5/6 mx-auto`}>
      ...
      <section className="flex flex-col mx-auto mt-16 border rounded-lg border-gray-600 w-1/2 max-lg:w-5/6 max-lg:p-3 p-6">
        <div className="flex items-center justify-between w-full">
          <h1
            className={`${geistSans.className} text-4xl font-bold max-lg:text-2xl`}
          >
            Arthur Pavan
          </h1>
        ...
        <div
          className={`${geistMono.className} flex gap-2 items-center text-gray-900 dark:text-gray-500 mb-6 max-lg:mb-3 max-lg:text-[.9rem]`}
        >
          <MdLocationPin />
          <p> São Paulo, Brasil </p>
        </div>

        <p className={`${geistSans.className} text-lg  max-lg:text-[1rem]`}>
          {translate?.main.desc}
        </p>
      </section>
      ...
      <section className="flex flex-col mx-auto mt-8 w-1/2 max-lg:w-5/6">
        ...
        <div className="flex">
          <Link
            href="/project"
            className={`${geistSans.className} text-blue-600 dark:text-blue-400 text-lg mt-3 max-lg:text-[.9rem]`}
          >
            {translate?.main.more}
          </Link>
        </div>
